...
const _meshColors = [Color(0xFFE9135F), Color(0xFF9108BF), Color(0xFF8083FF)];
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                // ),
                CNButton.icon(
                  flutterIcon: const Icon(Icons.favorite_outline, size: 60, fill: 1, color: Colors.blue),
                  // icon: const CNSymbol('heart.fill', size: 18, color: CupertinoColors.destructiveRed),
                  style: CNButtonStyle.prominentGlass,
                  tint: CupertinoColors.transparent,
                  meshGradient: _meshVisible ? CNButtonMeshGradient(colors: [const Color(0xFFE9135F), const Color(0xFF9108BF), const Color(0xFF8083FF)], animationSpeed: 100) : null,
                  onPressed: () {},
                  size: 240,
                ),
              ],
            ...
            const SizedBox(height: 48),
            const Text('Mesh gradient fade'),
            const SizedBox(height: 12),
            Row(
              spacing: 16,
              children: [
                CNButton.icon(
                  icon: const CNSymbol('sparkles', size: 22, color: CupertinoColors.white),
                  style: CNButtonStyle.glass,
                  meshGradient: _meshVisible ? CNButtonMeshGradient(colors: _meshColors, animationSpeed: 10) : null,
                  onPressed: () {},
                ),
                CupertinoButton.filled(onPressed: () => setState(() => _meshVisible = !_meshVisible), child: Text(_meshVisible ? 'Fade out' : 'Fade in')),
              ],
            ),
            const SizedBox(height: 48),
